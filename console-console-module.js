...
/***/ "./node_modules/firebaseui-angular/fesm5/firebaseui-angular.js":
/*!*********************************************************************!*\
  !*** ./node_modules/firebaseui-angular/fesm5/firebaseui-angular.js ***!
  \*********************************************************************/
/*! exports provided: FirebaseuiAngularLibraryService, FirebaseuiAngularLibraryComponent, firebase, firebaseui, FirebaseUIAuthConfig, FirebaseUISignInSuccessWithAuthResult, FirebaseUISignInFailure, FirebaseUISignInSuccess, CredentialHelper, AuthProvider, AuthMethods, FirebaseUIModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseuiAngularLibraryService", function() { return FirebaseuiAngularLibraryService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseuiAngularLibraryComponent", function() { return FirebaseuiAngularLibraryComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "firebase", function() { return firebase$1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "firebaseui", function() { return firebaseui$1; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseUISignInSuccessWithAuthResult", function() { return FirebaseUISignInSuccessWithAuthResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseUISignInFailure", function() { return FirebaseUISignInFailure; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseUISignInSuccess", function() { return FirebaseUISignInSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CredentialHelper", function() { return CredentialHelper; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseUIModule", function() { return FirebaseUIModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/fire/auth */ "./node_modules/@angular/fire/auth/index.js");
/* harmony import */ var firebaseui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebaseui */ "./node_modules/firebaseui/dist/npm.js");
/* harmony import */ var firebaseui__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(firebaseui__WEBPACK_IMPORTED_MODULE_2__);
...
var FirebaseuiAngularLibraryService = /** @class */ (function () {
    function FirebaseuiAngularLibraryService(angularFireAuth) {
        ...
        if (!(/** @type {?} */ (window)).firebaseUiInstance) {
            (/** @type {?} */ (window)).firebaseUiInstance = new firebaseui__WEBPACK_IMPORTED_MODULE_2__["auth"].AuthUI(angularFireAuth.auth);
        }
    ...
    /** @nocollapse */ FirebaseuiAngularLibraryService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({ factory: function FirebaseuiAngularLibraryService_Factory() { return new FirebaseuiAngularLibraryService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["inject"])(_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"])); }, token: FirebaseuiAngularLibraryService, providedIn: "root" });
 ...
 */
/** @type {?} */
var firebase$1 = firebase_app__WEBPACK_IMPORTED_MODULE_3__;
/** @type {?} */
var firebaseui$1 = firebaseui__WEBPACK_IMPORTED_MODULE_2__;
/**
...
var FacebookAuthProvider = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].FacebookAuthProvider;
var TwitterAuthProvider = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].TwitterAuthProvider;
var GithubAuthProvider = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].GithubAuthProvider;
var EmailAuthProvider = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].EmailAuthProvider;
var PhoneAuthProvider = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].PhoneAuthProvider;
var FirebaseuiAngularLibraryComponent = /** @class */ (function () {
    function FirebaseuiAngularLibraryComponent(angularFireAuth, firebaseUiConfig, firebaseUIService) {
         ...
         */
        this.signInSuccessCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.signInSuccessWithAuthResultCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.signInFailureCallback = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    /**
     * @param {?} provider
     * @return {?}
    ...
    function () {
        ...
        if (!(/** @type {?} */ (this.firebaseUiConfig)).providers) {
            if (!(/** @type {?} */ (this.firebaseUiConfig)).callbacks) {
                ...
                (/** @type {?} */ (this.firebaseUiConfig)).callbacks = this.getCallbacks();
            }
        ...
        var authProviders = [];
        try {
            for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_4__["__values"])(authConfig.providers), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        switch (authConfig.credentialHelper) {
            case CredentialHelper.None:
                credentialHelper = firebaseui__WEBPACK_IMPORTED_MODULE_2__["auth"].CredentialHelper.NONE;
                break;
            ...
            default:
                credentialHelper = firebaseui__WEBPACK_IMPORTED_MODULE_2__["auth"].CredentialHelper.ACCOUNT_CHOOSER_COM;
                break;
        }
        /** @type {?} */
        ...
        /** @type {?} */
        var callbacks = Object(tslib__WEBPACK_IMPORTED_MODULE_4__["__assign"])({}, this.getCallbacks(), { signInSuccess: null });
    ...
    function () {
        ...
        if (resetCallbacks) {
            (/** @type {?} */ (this.firebaseUiConfig)).callbacks = null;
        }
    };
    /**
     * @return {?}
    ...
    FirebaseuiAngularLibraryComponent.ctorParameters = function () { return [
        { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"], args: ['firebaseUIAuthConfig',] }] },
        { type: FirebaseuiAngularLibraryService }
    ]; };
    FirebaseuiAngularLibraryComponent.propDecorators = {
        signInSuccessCallback: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"], args: ['signInSuccess',] }],
        signInSuccessWithAuthResultCallback: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"], args: ['signInSuccessWithAuthResult',] }],
        signInFailureCallback: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"], args: ['signInFailure',] }]
    };
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function() { var firebase=__webpack_require__(/*! firebase/app */ "./node_modules/firebase/app/dist/index.cjs.js");__webpack_require__(/*! firebase/auth */ "./node_modules/firebase/auth/dist/index.esm.js");if(typeof firebase.default!=='undefined'){firebase=firebase.default;}/*
...
dialogPolyfill["registerDialog"]=dialogPolyfill.registerDialog;if("function"==="function"&&"amd"in __webpack_require__(/*! !webpack amd define */ "./node_modules/webpack/buildin/amd-define.js"))!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(){return dialogPolyfill}).call(exports, __webpack_require__, exports, module),
...
var routes = [
    ...
    { path: 'transfer', component: _transfer_transfer_component__WEBPACK_IMPORTED_MODULE_3__["TransferComponent"] },
    { path: 'withdraw', component: _withdraw_withdraw_component__WEBPACK_IMPORTED_MODULE_4__["WithdrawComponent"] },
    { path: 'historical', component: _historical_historical_component__WEBPACK_IMPORTED_MODULE_5__["HistoricalComponent"] }
];
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnNvbGUvaGlzdG9yaWNhbC9oaXN0b3JpY2FsLmNvbXBvbmVudC5jc3MifQ== */"
...
module.exports = "<firebase-ui></firebase-ui>\r\n<div class=\"container shadow\" *ngIf=\"user\">\r\n  <div class=\"row center\">\r\n    <div class=\"col s12 m8 offset-m2\">\r\n      <a class=\"waves-effect waves-light btn-large\" (click)=\"logOut()\">Cerrar sesión</a>\r\n      <br />\r\n      {{user}}\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authenticationService) {
        ...
        this.authResult = this.authenticationService.authResult;
    }
    ...
    LoginComponent.prototype.getUser = function () {
        ...
        this.user = this.authenticationService.getStatus()
            ...
            if (response.emailVerified) {
                _this.user = response.providerData;
                _this.user = JSON.stringify(_this.user);
            }
            else {
                _this.user = 'Por favor verificar email.';
            }
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnNvbGUvdHJhbnNmZXIvdHJhbnNmZXIuY29tcG9uZW50LmNzcyJ9 */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnNvbGUvdXNlci91c2VyLmNvbXBvbmVudC5jc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnNvbGUvd2l0aGRyYXcvd2l0aGRyYXcuY29tcG9uZW50LmNzcyJ9 */"
...
/*!****************************************************!*\
  !*** ./src/app/services/authentication.service.ts ***!
  \****************************************************/
/*! exports provided: firebaseUiAuthConfig, AuthenticationService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/fire/auth */ "./node_modules/@angular/fire/auth/index.js");
/* harmony import */ var firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebaseui-angular */ "./node_modules/firebaseui-angular/fesm5/firebaseui-angular.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    signInOptions: [
        {
            ...
            provider: firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.FacebookAuthProvider.PROVIDER_ID
        },
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.TwitterAuthProvider.PROVIDER_ID,
        {
            requireDisplayName: true,
            provider: firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.EmailAuthProvider.PROVIDER_ID
        },
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.PhoneAuthProvider.PROVIDER_ID,
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.GoogleAuthProvider.PROVIDER_ID,
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebase"].auth.GithubAuthProvider.PROVIDER_ID,
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebaseui"].auth.AnonymousAuthProvider.PROVIDER_ID
    ],
    tosUrl: '<your-tos-link>',
    privacyPolicyUrl: '<your-privacyPolicyUrl-link>',
    credentialHelper: firebaseui_angular__WEBPACK_IMPORTED_MODULE_2__["firebaseui"].auth.CredentialHelper.NONE
};
